...
//        reviewServiceUrl = "http://" + reviewServiceHost + ":" + reviewServicePort + "/review";
    ...
    /**
     * The circuit breaker can be applied by annotating the method it is expected to pro
     * tect with @CircuitBreaker(...), which, in this case, is the getProduct() method in the
     * ProductCompositeIntegration class.
     *
     * The circuit breaker is triggered by an exception, not by a timeout itself. To be able to trigger the
     * circuit breaker after a timeout, we will add a time limiter that can be applied with the annotation
     * @TimeLimiter(...).
     *
