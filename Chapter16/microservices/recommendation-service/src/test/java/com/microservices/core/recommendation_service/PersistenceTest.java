...
public class PersistenceTest {
    ...
    void setupDb() {
        ...
        // .block() internally ek temporary subscriber bana ke stream execute karta hai aur thread ko wait
        // karata hai jab tak data ya error ya complete signal nahi milta. Ask the thread to wait forcefully till
        // it get the result.
