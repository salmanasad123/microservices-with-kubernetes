 ...
 *
 * Added to the explanations for the preceding product entity, we can see how a unique compound
 * index is created using the @CompoundIndex annotation for the compound business key based on the
 * productId and recommendationId fields.
 */
